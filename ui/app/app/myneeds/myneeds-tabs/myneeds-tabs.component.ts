...
@Component({
  selector: 'oe-myneeds-tabs',
  templateUrl: './myneeds-tabs.component.html',
  styleUrls: ['./myneeds-tabs.component.scss']
})
export class MyneedsTabsComponent implements OnInit {
